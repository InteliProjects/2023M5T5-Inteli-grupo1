...
import filtration from "../../assets/img/filtration.svg";

// função que renderiza o nó de Filtration
export default function Filtration(props: NodeProps) {
  return (
    <Popover.Root>
      <Popover.Trigger asChild>
        <div className="rounded w-[180px] h-[100px] flex items-center justify-center text-center text-white">
          <img src={filtration} alt="Filtration node" width={180}/>
          <Handle
            id="right"
            type="source"
